...
class TestGetTaggedResourceArns:
    ...
    def test_returns_arns_matching_tag_key_and_value(self):
                    ...
                    "ResourceTagMappingList": [
                        {
                            ...
                            "Tags": [{"Key": "Project", "Value": "ShiftCommute"}],
                        },
                        {
        ...
        result = get_tagged_resource_arns(aws_data, "Project", "ShiftCommute")
                    ...
                    "ResourceTagMappingList": [
                        {
                            ...
                            "Tags": [
                                ...
                                {"Key": "Project", "Value": "ShiftCommute"},
                            ],
                        },
                    ]
                }
    ...
    def test_returns_empty_set_when_key_missing_entirely(self):
        assert get_tagged_resource_arns({}, "Project", "ShiftCommute") == set()
